...
async function request(token, method, path, body, extraHeaders = {}) {
...
export function webPost(token, path, body, extraHeaders) {
  return request(token, "POST", path, body, extraHeaders);
}
